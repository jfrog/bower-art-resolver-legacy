...
var semver = require('bower-poc').util.semver;
...
ArtifactoryResolver.prototype._resolve = function () {
    ...
    var resolve = ArtifactoryResolver.doArtifactoryHeadRequest(requestUrl, bowerConfig)
        .then(function (headResponse) {
            ...
            var contentDisposition = ArtifactoryResolver.collectHeaderFileName(headResponse);
...
ArtifactoryResolver.refs = function (source) {
    var config = require('bower-poc').config;
